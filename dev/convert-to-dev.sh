...
# This script converts a vm from distribution mode to development mode
...
sudo rm manage.py
sudo -u apache ln -s /src/steelscript-appfwk/steelscript/appfwk/apps/../manage.py
sudo rm media
sudo -u apache ln -s /src/steelscript-appfwk/steelscript/appfwk/apps/../media
sudo rm thirdparty
sudo -u apache ln -s /src/steelscript-appfwk/steelscript/appfwk/apps/../thirdparty

# update progressd service to new location
sudo sed -i.bak -e 's#/home/vagrant/virtualenv/lib/python2.7/site-packages/steelscript/appfwk/progressd#/src/steelscript-appfwk/steelscript/appfwk/progressd#' /etc/init.d/progressd
